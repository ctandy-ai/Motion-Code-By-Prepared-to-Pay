...
- **AI Coach Assistant**: Integrates GPT-4.1 via Replit AI Integrations, providing performance insights, program recommendations, and conversational assistance. It is context-aware (athlete stats) and includes compliance safeguards to avoid medical advice.
